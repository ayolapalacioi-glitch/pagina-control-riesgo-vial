...
const classes = ['peaton', 'motocicleta', 'automovil', 'bus_transcaribe', 'ciclista'];
function rand(min, max) {
    return Math.random() * (max - min) + min;
}
function randomDetection(trackId) {
...
const outputPath = path_1.default.resolve(process.cwd(), '../data/sample-sensecraft-json.json');
